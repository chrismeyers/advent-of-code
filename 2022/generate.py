...
if __name__ == "__main__":
    ...
    day_dir = f"{dir}/day{formatted_day}"
        ...
        f.write(
            "\n".join(
                [
                    "import os",
                    "import unittest",
                    f"from day{formatted_day}.solutions import part1, part2",
                    "",
                    "",
                    ...
                    "        self.assertEqual(part1(self.sample_data), 0)",
                    "",
                    "    def test_part1_input(self):",
                    "        self.assertEqual(part1(self.input_data), 0)",
                    "",
